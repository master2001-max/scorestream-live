      ...
      <div className="bg-white shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          ...
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">Announcement Management</h3>
            <p className="mt-1 text-sm text-gray-500">
              This feature will allow you to manage all announcements across the system.
            </p>
            <div className="mt-6">
